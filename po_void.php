            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <th style="text-align:center;">No</th>
                  ...
                  <th style="text-align:center;">Tanggal Void</th>
                ...
                $barang = $_POST['barang'];
                $sql = mysqli_query($koneksi, "SELECT a.*, b.* FROM transaksi_header as a INNER JOIN transaksi_detail as b ON a.no_po = b.no_po  where ((b.tgl_input BETWEEN '$tgl1' AND '$tgl2' OR b.tipe_barang = '$barang') AND a.flag_hapus='1' )  GROUP BY a.no_po ORDER BY a.tgl_create DESC LIMIT 20 ");
                $no = 0;
                ...
                <tr>
                  ...
                  <td style="text-align:center;"><?php echo $data['tgl_edit']; ?></td>
                  <td style="text-align:center">

                   <form action="<?php echo $base_url ?>print_void_po" method="post" target="_blank">
