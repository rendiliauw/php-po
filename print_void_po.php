  ...
  <section class="invoice">
    ...
    <!-- Table row -->
            ...
            <table id="example1" class="table table-bordered">
              ...
              $sql = mysqli_query($koneksi, "SELECT * FROM transaksi_detail where flag_hapus='1' AND no_po='$id'   ORDER BY id ASC");
              $no = 0;
            ...
            <?php
  $sql = mysqli_query($koneksi, "SELECT sum(total_harga) as 'total' from transaksi_detail where no_po = $id and flag_hapus=1 
