...
if(isset($_POST['simpan'])){        
    ...
    $sql= mysqli_query($koneksi,"INSERT INTO mst_unit SET
                    kode = '$kode',
                    nama_unit = '$nama_unit',
                    tgl_create = '$datetime',
                    user_create = '',
        ...
        if($sql){
            echo "Data berhasil di tambah"."<meta http-equiv='refresh' content='1; url=mst_unit_view'>";
         }else{
    ...
    $sql= mysqli_query($koneksi,"UPDATE mst_unit SET
                    kode = '$kode',
                    nama_unit = '$nama_unit' WHERE id = '$_POST[id]'
                    ");
      ...
      $id = $_POST['id'];
          ...
          if($sql){
           ...
           if(isset($_POST['edit'])){ 
            $id = $_POST['id'];
            $sql = mysqli_query($koneksi, "SELECT * FROM mst_unit WHERE id='$id' ");
...
<input type="text" class="form-control" id="nama_unit" name="nama_unit" <?php if(isset($_POST['edit'])){ ?>value="<?php echo $data['nama_unit']; ?>" <?php } ?> required>
        </div>
      </div>
      <!-- /.box-body -->
      ...
      <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                 <?php
                    $sql = mysqli_query($koneksi,"SELECT * FROM mst_unit WHERE flag_hapus='0' ORDER BY id DESC");
                    $no =0;
